...
<html lang="en">
    <head>
        ...
        <script src="https://kit.fontawesome.com/8f261d8738.js" crossorigin="anonymous"></script>
        <!-- Google fonts-->
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#sertifikat">Sertifikat</a></li>
                </ul>
            </div>
        </nav>
        <!-- Page Content-->
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-5">
                        {{ get_meta_value('_kota') }} - {{ get_meta_value
                        ('_provinsi') }} - {{ get_meta_value('_nohp') }}-
                         <a href="{{ url('https://mail.google.com/mail/u/0/?view=cm&tf=1&fs=1&to=gurmelsingh899@gmail.com') }}">{{
                    ...
                    <div class="social-icons">
                        ...
                        <a class="social-icon" href="{{ get_meta_value('_twitter') }}"><i class="fa-brands fa-x-twitter"></i></a>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Universitas {{ $item->judul }}</h3>
                            <div class="subheading mb-3">Fakultas {{ $item->info1 }}</div>
                            <div>Prodi {{  $item->info2  }}</div>
                            <p>IPK: {{ $item->info3 }}</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">{{ 
                        $item->tgl_mulai_indo }} -
            ...
            <section class="resume-section" id="skills">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-3 mt-2">Workflow</div>
