...
<div class="pb-3"><a href="{{ route('education.create') }}" class="btn btn-outline-success">+Tambah Education</a></div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form onsubmit="return confirm('Yakin anda ingin menghapus data ini')" action="{{ route('education.destroy',$item->id) }}"
