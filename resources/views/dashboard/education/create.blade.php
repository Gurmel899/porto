...
@section('konten')
    <div class="pb3"><a href="{{ route('education.index') }}"class="btn btn-outline-secondary">
       << kembali</a>
 </div>
    <form action="{{ route('education.store') }}" method="POST">
        ...
        <div class="mt-3 mb-2">
            ...
            aria-describedby="helpId"
            placeholder="Index Kamulatif Prestasi" value="{{ Session::get('info3') }}"/>
        </div>
        <div class="mt-3 mb-2">
          <div class="row">
            <div class="col-auto">Tanggal Mulai</div>
            <div class="col-auto"><input type="date"class="form-control
                form-control-sm" name="tgl_mulai" placeholder="dd/mm/yyyy"value="{{ Session::get('tgl_mulai') }}"></div>
            <div class="col-auto">Tanggal Akhir</div>
            <div class="col-auto"><input type="date"class="form-control
                form-control-sm" name="tgl_akhir" placeholder="dd/mm/yyyy"value="{{ Session::get('tgl_akhir') }}"></div>
          </div>
        </div>
