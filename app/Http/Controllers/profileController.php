...
class profileController extends Controller
{
    ...
    function update(Request $request)
    {
        ...
        $request->validate([
            ...
            '_foto.mimes'=>'Foto yang dimasukan hanya diperbolehkan berekstensi
             JPEG,JPG,PNG,GIF',
        ...
        if ($request->hasFile('_foto')) {
            ...
            $extention =$foto_file->extension();
            $foto_baru = date('ymdhis').".$extention";
            $foto_file->move(public_path('foto'),$foto_baru); 

            //cek jika ada foto lama untuk update foto
